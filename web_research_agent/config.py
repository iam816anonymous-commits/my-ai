...
CONFIDENCE_THRESHOLD = get_env_int("CONFIDENCE_THRESHOLD", 85)
COVERAGE_THRESHOLD = get_env_int("COVERAGE_THRESHOLD", 85)
MIN_SOURCES_PER_OBJECTIVE = get_env_int("MIN_SOURCES_PER_OBJECTIVE", 3)
MIN_DOMAINS_PER_OBJECTIVE = get_env_int("MIN_DOMAINS_PER_OBJECTIVE", 3)
MIN_STRONG_CLAIMS = get_env_int("MIN_STRONG_CLAIMS", 2)
SATURATION_THRESHOLD_PERCENT = get_env_int("SATURATION_THRESHOLD_PERCENT", 2)
MAX_SEARCH_BUDGET = get_env_int("MAX_SEARCH_BUDGET", 25)
